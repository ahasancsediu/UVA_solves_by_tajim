...
function generateList() {
	...
	for(i=0; i<problems.length; i++) {
		...
		var link_problem = '<a style="margin-right: 4px"  href="http://uva.onlinejudge.org/external/'+id.slice(0,id.length-2)+'/'+id+'.html" title="Problem"><img src="icon_problem.png" width="15" height="16" alt="Problem" title="Problem" /></a>';
...
function hiddenForm(id) {
	...
	'<td style="vertical-align: top"><textarea style="height: 215px" readonly="readonly" tabindex="'+id+'3" id="output_'+id+'" />'+(savedOutput[id]?savedOutput[id]:'')+'</textarea>Note: Output capped if larger than 1 megabyte. </td></tr>'+
